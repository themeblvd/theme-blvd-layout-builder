...
class Theme_Blvd_Builder_API {
	...
	private function set_core_elements() {
		...
		$this->core_elements['jumbotron']['info'] = array(
			'name'		=> __( 'Jumbotron', 'theme-blvd-layout-builder' ),
			'id'		=> 'jumbotron',
		...
		$this->core_elements['jumbotron']['options'] = array(
			...
			'title_size' => array(
				'id' 		=> 'title_size',
				'name' 		=> __( 'Title Size', 'theme-blvd-layout-builder'),
				'desc'		=> __( 'Select the size of the title text.', 'theme-blvd-layout-builder'),
				'std'		=> '30px',
				'type'		=> 'slide',
				'options'	=> array(
					'units'	=> 'px',
			...
			'title_color' => array(
				'id' 		=> 'title_color',
				'name' 		=> __( 'Title Color', 'theme-blvd-layout-builder'),
				'desc'		=> __( 'Select a text color for the title text.', 'theme-blvd-layout-builder'),
				'std'		=> '#444444',
				'type'		=> 'color'
			),
			'text_size' => array(
				'id' 		=> 'text_size',
				'name' 		=> __( 'Text Size', 'theme-blvd-layout-builder'),
				'desc'		=> __( 'Select the size of the content text.', 'theme-blvd-layout-builder'),
				'std'		=> '18px',
				'type'		=> 'slide',
				'options'	=> array(
					'units'	=> 'px',
			...
			'text_color' => array(
				...
				'desc'		=> __( 'Select a text color for the content text.', 'theme-blvd-layout-builder'),
				'std'		=> '#444444',
				'type'		=> 'color'
			),
		    'text_align' => array(
		...
		$this->core_elements['team_member']['options'] = array(
			...
			'icons' => array(
				'id' 		=> 'icons',
				'name'		=> __( 'Social Media Icons', 'theme-blvd-layout-builder' ),
		...
		$this->core_elements['testimonial']['options'] = array(
			'text' => array(
				'id' 		=> 'text',
				'name' 		=> __( 'Testimonial Text', 'theme-blvd-layout-builder'),
				'desc'		=> __( 'Enter any text of the testimonial.', 'theme-blvd-layout-builder'),
				'type'		=> 'textarea',
				'editor'	=> true,
				'code'		=> 'html'
		    ),
	...
	private function set_core_layouts() {
		...
		$this->core_layouts['stats'] = array(
			...
			'id'				=> 'stats',
			'dir'				=> TB_BUILDER_PLUGIN_DIR . '/includes/admin/sample/stats/',
			'uri'				=> TB_BUILDER_PLUGIN_URI . '/includes/admin/sample/stats/',
			'assets'			=> TB_BUILDER_PLUGIN_URI . '/includes/admin/sample/assets/'
		);
